...
def just_walk(G, 
    ...
    def stay():
        ...
        next_node = random.choice(homo_nodes)
        cur_len += 1
    ...
    def jump():
        next_type = random.choice(list(set(all_types) - set(dq)))
        next_node = random.choice(G[cur_node][next_type])
        cur_len = 1
        walk.append(next_node)
        dq.append(next_type)
        return next_node
...
if __name__ == "__main__":
    ...
    main(dataset, full_graph, alpha, qlen, cvg, wlen, multiproc) 
