...
def main(dataset, full_graph):
    ...
    with open(DATA_DIR + "{}.edges{}".format(dataset, data_suffix), "r") as fin, \
        open(REFORM_DATA_DIR + "{}.hin_edges{}".format(dataset, data_suffix), "w") as fout: 
...
if __name__ == "__main__":
    ...
    if not os.path.isdir(REFORM_DATA_DIR):
        os.mkdir(REFORM_DATA_DIR)
